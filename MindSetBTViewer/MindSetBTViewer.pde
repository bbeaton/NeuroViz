...
float[] yFactors = {1*.25f,1*8f,1*8f,1*4f,1f,1f,1f,1f,1f,1f,1f,1f,1f,1f,1f,1f}; 
...
void controlEvent(ControlEvent theEvent) {
  ...
  else if (id == 1200) { // adds time stamp into results file
     if (saveDataBool == true){
        output.println("########## BEGIN STAMP FOR PART " + stamps + " ##########");     }
  }  

  else if (id == 1300) { // adds time stamp into results file
     if (saveDataBool == true){
        output.println("########## ANSWER STAMP FOR QUESTION " + answer + " ##########");     }
        answer++;
  } 

  else if (id == 1400) { // adds time stamp into results file
     if (saveDataBool == true){
